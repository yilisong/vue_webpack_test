<template lang="html">
  <el-dialog title="推送" size="small" :visible.sync="sendVisible" class="small_el_dialog" :before-close="closeSendVisible">
        ...
        <el-col :span="20">
          <el-table :data="serverList" style="width: 100%" class="sendSet">
            ...
            <template scope="scope">
                <el-button type="text" size="small" @click.native.prevent="deleteRow(scope.$index, serverList)">解除分配</el-button>
              </template>
            </el-table-column>
          </el-table>
        </el-col>
    ...
    <div slot="footer">
      <el-button @click="closeSendVisible" size="small">取 消</el-button>
      <el-button type="primary" @click="handleSendSubmit" size="small">确 定</el-button>
    </div>
  </el-dialog>
</template>
