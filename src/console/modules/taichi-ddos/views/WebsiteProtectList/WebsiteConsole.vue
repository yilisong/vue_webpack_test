...
export default {
  ...
  methods: {
    ...
    getHwwsStatus() {
      ...
      TaichiResource.getHwwsStatus(id).then(response => {
    ...
    getProtectCcData() {
      ...
      TaichiResource.getProtectCcData(param).then(response => {
    ...
    saveCcAddBlackData(row) {
      ...
      const id = this.$route.params.id
      TaichiResource.saveAddData(param, id)
        .then(response => {
    ...
    delCcData(row) {
      ...
      TaichiResource.delListData(id, domainId)
        .then(response => {
            this.$message({
              showClose: true,
              message: '删除成功',
    ...
    saveCcEditkData(row) {
      ...
      this.protectCcTableLoading = true
      TaichiResource.saveCcEditkData(id, domainId, params)
        .then(response => {
            this.$message({
              showClose: true,
              message: '修改成功',
    ...
    getProtectUrlList() {
      TaichiResource.getDomainList().then(response => {
      ...
      TaichiResource.getProtectUrlList(this.$route.params.id).then(response => {
    ...
    changeProtectUrlList() {
      ...
      TaichiResource.changeProtectUrlList(domainId, {
    ...
    getProtectCcSetting() {
      ...
      TaichiResource.getProtectCcSetting(
    ...
    changeProtectCcSetting(param) {
      ...
      TaichiResource.changeProtectCcSetting(domainId, params)
        .then(response => {
          if (response.data.status.code === 1) {
