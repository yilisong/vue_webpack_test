<template lang="html">
  <div class="overview-head">
    ...
    <a href="/console/finance-center#/rechargeList">
      <el-button type="text">充值管理</el-button>
    </a>
    <span class="division"></span>
    ...
    <a href="/console/finance-center#/invoiceList">
      <el-button type="text">发票管理</el-button>
    </a>
    <div class="pull-right">
      <img class="we-code" src="../assets/images/small-code.png" alt="">
      <span class="attention">关注我们</span>
      <span class="division"></span>
      <el-popover ref="wechat" placement="bottom" width="120" trigger="hover">
        <img class="wechat" src="../assets/images/wechat-subscription.jpg" alt="">
      </el-popover>
      <span v-popover:wechat>微信订阅号</span>
      <span> / </span>
      <el-popover ref="service" placement="bottom" width="120" trigger="hover">
        <img class="wechat" src="../assets/images/wechat-service.png" alt="">
      </el-popover>
