...
<div class="content-padding base-border" v-if="haveService">
  ...
  <el-row :gutter="20" v-if="haveBasicApply">
    <el-col :span="24" class="title">
      {{ basicApply.title }}
    </el-col>
    <el-col :lg="8" :md="12" class="service-box basicApply" v-for="(item,index) in basicApply.serviceList" :key="index">
  ...
  <el-row :gutter="20" v-if="haveWebCDN">
    <el-col :span="24" class="title">
      {{ webCDN.title }}
    </el-col>
    <el-col :lg="8" :md="12" class="service-box webCDN" v-for="(item,index) in webCDN.serviceList" :key="index">
      <div class="disservice-box base-border">
        <i :class="'icon-'+item.name"></i>
  ...
  <el-row :gutter="20" v-if="haveCloudSafe">
    <el-col :span="24" class="title">
      {{ cloudSafe.title }}
    </el-col>
    <el-col :lg="8" :md="12" class="service-box cloudSafe" v-for="(item,index) in cloudSafe.serviceList" :key="index">
      <div class="disservice-box base-border">
        <i :class="'icon-'+item.name"></i>
  ...
  <el-row :gutter="20" v-if="haveTaichiDDos">
    <el-col :span="24" class="title">
      {{ taichiDDos.title }}
    </el-col>
    <el-col :lg="8" :md="12" class="service-box taichiDDos" v-for="(item,index) in taichiDDos.serviceList" :key="index">
      <div class="disservice-box base-border">
        <i :class="'icon-'+item.name"></i>
