<template lang="html">
  <div v-if="showTip">
    <el-row class="migrate-tip" :gutter="0">
      <el-col :span="2" class="custom-width">
        <span class="tip-title">
          <img class="note" src="../assets/images/note.png" alt="">迁移通知
        </span>
      </el-col>
      <el-col :span="1">
      ...
      <el-col :span="2" class="custom-close-width">
    ...
    <el-dialog title="升级说明" :visible.sync="explainDialog" size="small">
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="explainDialog = false">取 消</el-button>
      </span>
    </el-dialog>
    <el-dialog title="升级说明" :visible.sync="migratedExplainDialog" size="small">
      <ul class="explain-content">
        <li>
          <i class="again-dot"></i>
          <p>迁移后的套餐对应关系</p>
          <el-table class="el-table" :data="migrateTableData" border>
            <el-table-column prop="old" label="旧平台套餐">
            </el-table-column>
            <el-table-column prop="fresh" label="新平台套餐">
            </el-table-column>
          </el-table>
        </li>
        <li>
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="migratedExplainDialog = false">取 消</el-button>
      </span>
    </el-dialog>
  </div>
</template>
