    ...
    <div slot="body" :data-value="nearlyOut">
      ...
      <div class="header">
        <span v-if="nearlyOut.expiry_flag === 1">
          <el-button type="primary" icon="fa-cart-plus" class="margin-15r" @click="info('expiration7')">添加网站</el-button>
        </span>
        <span v-else-if="nearlyOut.expiry_flag === 2">
          <el-button type="primary" icon="fa-cart-plus" class="margin-15r" @click="info('expiration')">添加网站</el-button>
        </span>
        <span v-else-if="nearlyOut.exhaustion === 4">
          <el-button type="primary" icon="fa-cart-plus" class="margin-15r" @click="info('full')">添加网站</el-button>
        </span>
        <span v-else>
          <el-button type="primary" icon="fa-cart-plus" class="margin-15r" @click="addDoubleMirror">添加网站</el-button>
        </span>
      ...
      <el-table :data="getDoubleMirrorData" element-loading-text="拼命加载中" fit  style="width: 100%" @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="" label="操作" align="left">
          <template scope="scope">
            <span v-if="nearlyOut.expiry_flag === 1">
              <el-button type="text" @click="info('expiration7')">立即更新</el-button>
              <span class="">|</span>
              <el-button type="text" @click="info('expiration7')">预览</el-button>
              <span class="">|</span>
              <el-button type="text" @click="info('expiration7')">配置</el-button>
            </span>
            <span v-else-if="nearlyOut.expiry_flag === 2">
              <el-button type="text" @click="info('expiration')">立即更新</el-button>
              <span class="">|</span>
              <el-button type="text" @click="info('expiration')">预览</el-button>
              <span class="">|</span>
              <el-button type="text" @click="info('expiration')">配置</el-button>
            </span>
            <span v-else-if="nearlyOut.exhaustion === 4">
              <el-button type="text" @click="info('full')">立即更新</el-button>
              <span class="">|</span>
              <el-button type="text" @click="info('full')">预览</el-button>
              <span class="">|</span>
              <el-button type="text" @click="info('full')">配置</el-button>
            </span>
            <span v-else>
              <el-button type="text" @click="handleMirrorlist('UpDate', scope.row)">立即更新</el-button>
              <span class="">|</span>
              <el-button type="text" @click="handleMirrorlist('Previews', scope.row, scope.row.webcdn_protected_status, scope.row.protocol)">预览</el-button>
              <span class="">|</span>
              <el-button type="text" @click="handleMirrorlist('Deploy', scope.row)">配置</el-button>
            </span>
          </template>
        </el-table-column>
      </el-table>
