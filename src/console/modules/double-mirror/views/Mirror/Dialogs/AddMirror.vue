...
" :closeOnClickModal="true" v-model="showAddMirrorVisible" :close-on-click-modal="false" :show-close="false" @close="triggerAddMirrorVisible(false)">
    ...
    <el-row :gutter="12" class="first_row">
      ...
      <el-col :span="1">
        <el-button class="addbtn" type="primary" icon="fa-cart-plus" @click="addMirrorListTable">+</el-button>
      </el-col>
    </el-row>
    <el-row :gutter="12" class="first_row">
    ...
    <div slot="footer">
      <el-button @click="closeAddDoubleMirrorDialog" size="small">取 消</el-button>
      <el-button type="primary" @click="saveAddMirror" size="small">确 定</el-button>
    </div>
  </el-dialog>
</template>
