            ...
            <template scope="scope">
              <el-popover ref="ifDelWebsite" placement="top" width="100" trigger="click" v-model="popoverInitialArray[scope.$index].flag">
                ...
                <div style="text-align: right; margin: 0">
                  <el-button size="mini" type="text" @click="handleInitialCancel(scope.$index)">取消</el-button>
                  <el-button type="primary" size="mini" @click="handleInitialConf(scope.$index)">确定</el-button>
                </div>
              </el-popover>
              <el-button type="text" icon="delete" v-popover:ifDelWebsite></el-button>
            </template>
          </el-table-column>
        </el-table>
      </el-col>
      <el-col :span="1">
        <el-button type="primary" size="small" @click="addInitialPage">+</el-button>
      </el-col>
    </el-row>
    <el-row :gutter="12" class="first_row">
          ...
          <el-table-column prop="" label="操作"  align="right">
            <template scope="scope">
              <el-popover ref="ifDelWebsite" placement="top" width="100" trigger="click" v-model="popoverArray[scope.$index].flag">
                <p>确认删除当前行的域名吗？</p>
                <div style="text-align: right; margin: 0">
                  <el-button size="mini" type="text" @click="handleCancel(scope.$index)">取消</el-button>
                  <el-button type="primary" size="mini" @click="handleConf(scope.$index)">确定</el-button>
                </div>
              </el-popover>
              <el-button type="text" icon="delete" v-popover:ifDelWebsite></el-button>
            </template>
      ...
      <el-col :span="1">
        <el-button type="primary" size="small" @click="addDeployMirror">+</el-button>
      </el-col>
    </el-row>
    <div slot="footer">
      <el-button @click="closeDeployMirror" size="small">取 消</el-button>
      <el-button type="primary" @click="saveDeployMirror" size="small">确 定</el-button>
    </div>
  </el-dialog>
</template>
