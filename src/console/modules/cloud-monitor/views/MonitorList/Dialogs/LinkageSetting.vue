    ...
    <div class="second-part">
      ...
      <div class="">
        <div class="" v-show="unsetting">
          ...
          <el-button style="margin-top: 12px;" @click="next" :disabled="totalNext">下一步</el-button>
        </div>
        <div class="" v-show="!unsetting">
          <h4>宕机联动设置</h4>
          ...
          <el-table :data="spareIPs" v-show="spareIP" v-bind:class="{tableShow:spareIP}">
            ...
            <template slot="append">
              ...
              <div class="button-box">
                <el-button type="text" size="small" @click="cancelContent">取消</el-button><el-button type="text" size="small" @click="saveSpareIp">保存</el-button>
              </div>
              </div>
                  <div class="">
                      <el-button type="text" @click="handleSpare(true)" class="add-button">+</el-button>
                  </div>
              </template>
          </el-table>
          <h4>宕机恢复处理</h4>
          ...
          <el-button style="margin-top: 12px;" @click="complete" :disabled="btnDiasbled">完成</el-button>
        </div>
