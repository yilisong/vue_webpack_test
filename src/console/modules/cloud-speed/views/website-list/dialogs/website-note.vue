<template lang="html">
  ...
  <el-dialog title="备注修改" :closeOnClickModal="true" v-model="websiteNoteVisible" size="small" :close-on-click-modal="true" @close="triggerWensiteNoteVisible(false)">
    ...
    <div slot="footer">
      <el-button @click="triggerWensiteNoteVisible(false)">取 消</el-button>
      <el-button type="primary" @click="handleWebsiteNoteDialogSubmit" :loading="websiteNoteDialog.loading">修 改</el-button>
    </div>
  </el-dialog>
</template>
