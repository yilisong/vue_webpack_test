<template lang="html">
  ...
  <el-dialog title="点击认证" :closeOnClickModal="true" :visible.sync="clickCertifyVisible" size="tiny" :close-on-click-modal="true" @open="initClickCertifyDialog" @close="closeClickCertify">
    ...
    <div slot="footer">
      <el-button @click="clickCertifyVisible = false">取消</el-button>
      <el-button type="primary" @click="clickCertifyComplete" :loading="clickCertifyDialog.loading">完成认证</el-button>
    </div>
  </el-dialog>
</template>
