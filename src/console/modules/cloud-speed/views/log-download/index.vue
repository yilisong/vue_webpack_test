...
<console-page-layout title="下载日志">
  <div class="log_list_title">
    ...
    <span class="wrapper">
      <el-button type="">今天</el-button>
      <el-button type="">昨天</el-button>
      <el-button type="">7天</el-button>
      <el-button type="">本月</el-button>
      <el-button type="">近六月</el-button>
    </span>
  </div>
  <div>
    <el-table :data="logList" fit stripe highlight-current-row style="width: 100%"  @selection-change="handleTableSelectionChange" v-loading="logListLoading" element-loading-text="拼命加载中">
      ...
      <el-table-column label="下载方式">
          <template scope="scope">
            <div class="operation">
            使用<el-button type="text" size="small" @click="handleWebsiteOperate('console', scope.row)">迅雷下载</el-button>
              <el-button type="text" size="small" @click="handleWebsiteOperate('check', scope.row)">本地下载</el-button>
            </div>
          </template>
        </el-table-column>
    </el-table>
